...
<head>
    ...
    if ($_SESSION["LoggedIn"] == true) {
        ...
        if (isset($_POST['educationSave'])) {
            ...
            $params = [$education_img, $education_title, $education_write];
            $params2 = [$education_img];
            $educationSql->sqlsorgu('educationSave', 'INSERT INTO cardlesson (cardLessonImg, cardLessonTitle, cardLessonWrite) VALUES (?, ?, ?)', $params, 1, 'SELECT COUNT(*) FROM cardlesson WHERE cardLessonImg = ?', $params2);
            ...
            $params = [$education_img, $education_title, $education_write, $education_Id];
            $educationSql->sqlsorgu('educationUpdate', 'UPDATE cardlesson SET cardLessonImg=?, cardLessonTitle=?, cardLessonWrite=? WHERE  cardLessonID=?', $params, 0, 0, 0);
            $educationSql->sqlsorgu('educationDelete', 'Delete from cardlesson WHERE cardLessonImg=? And cardLessonTitle=? And cardLessonWrite=? AND cardLessonID=?', $params, 0, 0, 0);
        }
    } else {
