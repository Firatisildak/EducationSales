          ...
          <div class="col-md-9">
            <div class="row mt-5">
              <div class="col-md-4 col-4">
                <a href="egitimDetay.php"><img src="img/dersGorselleri/r1.jpg" alt="logo" class="img-fluid"></a>
              </div>
            ...
            <div class="row mt-3">
              <div class="col-md-4 col-4">
                <a href="egitimDetay.php"><img src="img/dersGorselleri/r2.jpg" alt="logo" class="img-fluid"></a>
              </div>
              <div class="col-md-8 col-8 leanLeft">
                <h5>HTML5 ve CSS3 Eğitimleri</h5>
                <p>sıfırdan ileri düzey eğitim serisi. Bu kurs, dünya genelindeki işletmelerin güvendiği ve en yüksek puan alan kurslardan oluşan koleksiyonumuz için seçilmiştir</p>
            ...
            <div class="row mt-3">
              ...
              <div class="owl-carousel own-theme text-center">
                ...
                <div class="card" data-merge="1.5">
                  <a href="egitimDetay.php"><img src="img/dersGorselleri/r3.jpg" alt="logo" class="img-fluid"></a>
                  <h5 class="titleCard">HTML5 ve CSS3 Eğitimleri</h5>
                  <p class="cardp">sıfırdan ileri düzey eğitim serisi.</p>
                </div>
                <div class="card" data-merge="1.5">
                  <a href="egitimDetay.php"><img src="img/dersGorselleri/r4.jpg" alt="logo" class="img-fluid"></a>
                  <h5 class="titleCard">HTML5 ve CSS3 Eğitimleri</h5>
                  <p class="cardp">sıfırdan ileri düzey eğitim serisi.</p>
                </div>
                <div class="card" data-merge="1.5">
                  <a href="egitimDetay.php"><img src="img/dersGorselleri/r5.jpg" alt="logo" class="img-fluid"></a>
                  <h5 class="titleCard">HTML5 ve CSS3 Eğitimleri</h5>
                  <p class="cardp">sıfırdan ileri düzey eğitim serisi.</p>
                </div>
                <div class="card" data-merge="1.5">
                  <a href="egitimDetay.php"><img src="img/dersGorselleri/r6.jpg" alt="logo" class="img-fluid"></a>
                  <h5 class="titleCard">HTML5 ve CSS3 Eğitimleri</h5>
                  <p class="cardp">sıfırdan ileri düzey eğitim serisi.</p>
                </div>
                <div class="card" data-merge="1.5">
                  <a href="egitimDetay.php"><img src="img/dersGorselleri/r7.jpg" alt="logo" class="img-fluid"></a>
                  <h5 class="titleCard">HTML5 ve CSS3 Eğitimleri</h5>
                  <p class="cardp">sıfırdan ileri düzey eğitim serisi.</p>
                </div>
              </div>
